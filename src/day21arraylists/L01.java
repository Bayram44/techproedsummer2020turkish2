...
public class L01 {
	...
	/*
	 ...
	 2) List'ler cok kullanisli method'lara sahiptir. Bu yuzden kullanimi kolay oldugu icin array'lere tercih edilir. 
	 3) Arrayler primitive ve reference'lari eleman olarak kabul ederler
	    Listler ise sadece non-primitive'leri eleman olarak kabul ederler.  
	*/
